...
//    }
    ...
    public void testFacebookLoginPage_emptyLastName() {
        ...
        String expectedAlert = lastNameValidationAlert.getText();  //firstNameValidationAlert
    ...
    public void testFacebookLoginPage_emptyFirstName() {
        ...
        String expectedAlert = firstNameValidationAlert.getText();  //firstNameValidationAlert
        Assert.assertEquals("What’s your name?", expectedAlert);
    }
    @Test
    ...
    public void testFacebookLoginPage_emptyEmail() {
        ...
        String expectedAlert = emptyEmailValidationAlert.getText();  //firstNameValidationAlert
    ...
    public void testFacebookLoginPage_emptyPassword() {
        ...
        String expectedAlert = passwordValidationAlert.getText();  //firstNameValidationAlert
